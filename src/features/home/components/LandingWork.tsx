    ...
    <section ref={rootRef} id="work" className="py-16 md:py-24 lg:py-28">
      <div className="mx-auto w-[calc(100%_-_48px)] max-w-[1216px]">
        ...
        <div className="work-intro text-center mb-16 md:mb-20">
          ...
          <h2 className="fade-up mx-auto min-w-0 max-w-3xl font-display text-[30px] font-extrabold leading-[33px] tracking-tight text-[#111827] md:text-[36px] md:leading-[40px]">
            {t('headingPre')}
            <span className="mt-1 block max-w-full whitespace-normal break-words text-[#525252] [overflow-wrap:anywhere]">
              {t('headingAccent')}
            </span>
          </h2>
        </div>
